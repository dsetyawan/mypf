...
export default props => (
		<div className={ `Share `
			...
			<a className="Share__iconwrapper twitter" href={`https://twitter.com/intent/tweet?text=${ props.title } by Danang Setyawan(@dsetyawan) ${ props.url}` }  target="_blank" rel="noopener noreferrer" data-size="large">
