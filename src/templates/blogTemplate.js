		...
		<div className={`Post ${ frontmatter.style }`}>
			...
			<div className="wrapper-post">
				<div className="Foot__Share">
					<Share title={frontmatter.title} url={`https://dsetyawan.com/` + frontmatter.path}/>
				</div>
				...
				<Layout location={ this.props.location }>
					<div>
						<SEO
							...
							//image={`https://dsetyawan.com${post.fields.thumbnail.childImageSharp.responsiveSizes.src}`}
							...
							<div className="Post__footer">
								...
								
								{
									...
									<Share fixed show={ this.state.show_share }
									 	title={post.frontmatter.title}
										url={`https://dsetyawan.com/` + post.frontmatter.path}/>
								}
							</div>
					</div>
				</Layout>
